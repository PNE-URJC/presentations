...
\column{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{ping-json-browser.png}
\column{0.5\textwidth}
\centering
\includegraphics[width=\textwidth]{ping-raw-browser.png}
\end{columns}

\vspace{0.1cm}

The URL has \textbf{three parts}: \texttt{rest.ensembl.org} (server) + \texttt{/info/ping} (endpoint) + \texttt{content-type=application/json} (parameters)
